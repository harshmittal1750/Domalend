  ...
  return (
    <>
      <div className="relative overflow-hidden">
        ...
        {/* Footer */}
        <footer className="relative py-20 px-4 mt-32 border-t border-border/50 overflow-hidden">
          {/* Background Pattern */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-2xl font-bold">DomaLend</h3>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  World's first lending protocol accepting fractionalized domain
                  tokens as collateral. Powered by AI.
                </p>
                <div className="flex items-center gap-3 pt-4">
                  ...
                  <a
                    href="https://github.com/harshmital1750/domalend"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-primary/10 hover:bg-primary/20 flex items-center justify-center transition-colors"
                  >
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a
                      href="https://youtu.be/viIFgxnhWlo"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-muted-foreground hover:text-primary transition-colors"
                    >
            ...
            <div className="pt-8 border-t border-border/50">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  <span>© 2025 DomaLend</span>
                  <span className="text-primary">•</span>
                  <span>Built for Doma Hackathon</span>
                </div>
                <div className="flex items-center gap-6 text-sm text-muted-foreground">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                    <span>Live on Doma Testnet</span>
                  </div>
                  <span className="hidden sm:inline">Chain ID: 97476</span>
                </div>
              </div>
            </div>
          </div>
